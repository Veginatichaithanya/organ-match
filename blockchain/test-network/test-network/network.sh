...
export PATH="/tmp/fabric-bin:${ROOTDIR}/../bin:${PWD}/../bin:$PATH"
export FABRIC_CFG_PATH="${PWD}/configtx"
export VERBOSE=false
export DOCKER_SOCK="${DOCKER_SOCK:-/var/run/docker.sock}"
export WSLENV="DOCKER_SOCK:$WSLENV"
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    rm -rf system-genesis-block/*.block organizations/peerOrganizations organizations/ordererOrganizations channel-artifacts 2>/dev/null || true
    ...
    rm -rf addOrg3/fabric-ca/org3/msp addOrg3/fabric-ca/org3/tls-cert.pem addOrg3/fabric-ca/org3/ca-cert.pem addOrg3/fabric-ca/org3/IssuerPublicKey addOrg3/fabric-ca/org3/IssuerRevocationPublicKey addOrg3/fabric-ca/org3/fabric-ca-server.db 2>/dev/null || true
